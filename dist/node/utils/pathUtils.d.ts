...
export declare function resolveFrom(root: string, id: string): string
export declare function osAgnosticPath(
...
export declare function mapQuery(
  url: string,
  mapper: (query: ParsedUrlQuery) => ParsedUrlQuery
): string
export declare function appendQuery(
  url: string,
